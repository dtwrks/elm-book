...
However, we also provide a zero-config dev server to make things easier. If you want to use it, just install `elm-book` as an npm devDependency then run `npx elm-book {MyBookModule}.elm` and you should see your brand new Book running on your browser.
